...
class GridView : public TableView
{
public:
     ...
     * @endcode
     */
    static GridView* create(TableViewDataSource* dataSource, cocos2d::Size const& size);
    /**
     ...
     * @endcode
     */
    static GridView* create(TableViewDataSource* dataSource, cocos2d::Size const& size, cocos2d::Node *container);
    /**
     * @js ctor
     */
    GridView();
    ...
    bool initWithViewSize(cocos2d::Size const& size, Node* container = NULL) override;
...
protected:
    ...
    virtual void _setIndexForCell(ssize_t index, TableViewCell *cell) override;

    virtual void _updateCellPositions() override;
...
public:
    virtual void _updateContentSize() override;
